...
parser.add_argument('--trained_model', default='pretrain/craft_mlt_25k.pth', type=str, help='pretrained model')
...
parser.add_argument('--refine_model', default='pretrain/craft_refiner_CTW1500.pth', type=str, help='pretrained model')
...
def test(modelpara, refinepara):
    ...
    if args.cuda:
        ...
        refine_net.state_dict(copyStateDict(torch.load(refinepara)))
    else:
